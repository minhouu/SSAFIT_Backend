...
//	}
	...
	public ResponseEntity<String> updateComment(@RequestBody ExerciseRecord exerciseRecord, @PathVariable int recordId,  @PathVariable int detailId, @RequestParam("user-seq") int userSeq) {
		exerciseRecord.setUserSeq(userSeq);
